...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, restoreInteractionStateWith stateRestorationActivity: NSUserActivity) {
        ...
        case .menu(let category):
            let menuTableViewController = storyboard.instantiateViewController(identifier: restorationController.identfier.rawValue, 
                creator: { (coder) in
        ...
        case .menuItemDetail(let menuItem):
            ...
            let menuItemDetailViewController = storyboard.instantiateViewController(identifier: restorationController.identfier.rawValue) { (coder) in
